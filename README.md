...
| 真机反馈 | Android 10 与 Android 16 两位测试者使用独立兼容测试版均反馈正常 |
...
兼容测试版在 Android 10（型号未提供）和 Android 16（维护者设备 BKQ AN80）已收到正常使用反馈。最终正式签名 APK 另行完成包体检查，未把测试版反馈当作它的逐项安装与运行验收。其他机型、Android 11～15 各版本及真正的 16 KB 页面环境仍待补充验证。相册可能忽略 GIF 循环次数，对透明背景或缩放的显示也可能不同。
