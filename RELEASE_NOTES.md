...
2026-09-24，两位测试者分别在 **Android 10** 和 **Android 16** 使用独立兼容测试版后反馈没有发现问题。Android 10 设备型号未提供；Android 16 为维护者设备 BKQ AN80。反馈来自兼容测试版，本次正式签名发布包另做签名、版本、权限、原生依赖和文件校验；尚无最终发布 APK 的逐项设备验收记录。
